...
#import "YCSimplePingDelegate.h"

@class NSString, NSTimer, YCSimplePing;

@interface YCNetPing : NSObject <YCSimplePingDelegate>
{
    _Bool _isStartSuccess;
    int _sendCount;
    int _successCount;
    long long _maxPingTime;
    long long _minPingTime;
    long long _sumPingTime;
    long long _startTime;
    NSString *_hostAddress;
    _Bool _isLargePing;
    NSTimer *timer;
    YCSimplePing *_pinger;
    id <YCNetPingDelegate> _delegate;
}

@property(nonatomic) __weak id <YCNetPingDelegate> delegate; // @synthesize delegate=_delegate;
@property(retain, nonatomic) YCSimplePing *pinger; // @synthesize pinger=_pinger;
- (void).cxx_destruct;
